...
test('Sağlık kontrolü gizli değer içermez, sürümü döndürür',()=>{const res={setHeader(){},status(n){this.code=n;return this;},json(x){this.body=x;}};health({},res);assert.deepEqual(res.body,{ok:true,version:'0.1.4',mode:'PAPER',service:'kripto-v2'});});
