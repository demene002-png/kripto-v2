...
$('#reset-test').onclick=()=>{if(state.positions.length){notice('Önce açık pozisyonların tamamını kapatın.');return;}if(confirm('Bakiye 1.000 USDT olarak yeniden başlatılsın mı? İşlem ve tarama geçmişi korunacaktır.'))action({action:'reset-test'});};
